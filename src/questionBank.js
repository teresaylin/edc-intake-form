const questions = [
  ...
  {
    question: "Plaintiff (landlord) is a ...",
    description: null,
    // inputType: "singleSelect",
    inputType: "select",
  ...
  {
    question: "Plaintiff (landlord)'s attorney name",
    description: null,
    inputType: "text",
    required: false,
    section: "Case Information"
  ...
  {
    question:
      "Has anyone in your household served in the United States military?",
    description: null,
    inputType: "select",
    options: ["Yes", "No"],
    required: false,
  ...
  {
    question:
      "Are you receiving any medical treatment or medications for any of these issues?",
    description: null,
    inputType: "text",
    required: false,
    section: "Additional Information"
  ...
  // {
  //   question:
  //     "What is your source of income? Are you receiving any of these benefits?",
  //   description: null,
  //   inputType: "multiSelect",
  //   options: [
  //     "CalWorks",
  ...
  //   description: null,
  //   inputType: "multiSelectSpecifyOther",
  //   options: ["US Mail", "Posted or taped to door", "Handed"],
  //   required: false,
  //   section: "Service of Summons and Complaint"
  // }
];
